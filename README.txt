...
Note: Many of the figures produced in R were 'cleaned up' in Adobe Illustrator to produce the final, published figures. 
Additionally, Figures 7a, S2a, and S8  were created using the GraphPad Prism software, with raw data and R code used for analysis provided.